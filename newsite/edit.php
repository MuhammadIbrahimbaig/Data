...
<body>
    <form class="form w-50 mt-5  mx-auto" action="edituser.php" method="post">
        <h1 class="ms-5 ">Edit Users</h1>
        <input value="<?php echo $users["id"]?>" placeholder="Enter your name" type="hidden" class="form-control p-1 mt-2" name="id">
        ...
        <input value="<?php echo $users["user_password"]?>" placeholder="Enter your password"  type="password" class="form-control p-1 mt-2" name="user_password">
